...
def MuonRC_cal_MC(roccor,genparticles,genIdx,Mucharge,Mupt,Mueta,Muphi,MunTrackerLayers):
...
class MinitreeProducer(Module):
	...
	if(self.letopn_flv == 'mu'):
	    ...
	    self.out.fillBranch("Muon_corrected_pt",MuonPt_corr)
