...
config.JobType.inputFiles = ['ElectronSF','MuonSF','crab_script_skimTree.py','scaleFactor.py','btv.py','jme.py','../../scripts/haddnano.py','keep_and_drop.txt','MainModule.py']
...
config.Data.outputDatasetTag = 'Tree_12_Oct21_Run2016H_mu'
