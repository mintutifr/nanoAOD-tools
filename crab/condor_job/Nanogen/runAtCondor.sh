...
pwd
ls -la
cp ../../Gen_mass_reconstract_SingleTop_minitree.py PhysicsTools/NanoAODTools/crab/Gen_Study/ 
cp ../../crab_script_NanoGen_minitree.py PhysicsTools/NanoAODTools/crab/Gen_Study/
scram b -j4

cd PhysicsTools/NanoAODTools/crab/Gen_Study/
echo "python crab_script_NanoGen_minitree.py"
python crab_script_NanoGen_minitree.py
