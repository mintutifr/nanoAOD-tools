...
config.Data.outLFNDirBase = '/store/user/mikumar/RUN2_UL/Tree_crab/SIXTEEN/MC_NaNOGEN/Tbarchannel_wtop1p45'

config.Data.publication = True

config.Data.outputDatasetTag = 'Tree_25_Jul22_MCUL2016_Tbarchannel_wtop1p45'
