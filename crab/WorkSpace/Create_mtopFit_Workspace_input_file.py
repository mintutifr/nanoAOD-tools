...
def Create_Workspace_input_file(lep="mu",year="UL2017",Variable="lntopMass"):
    ...
    for channel in channels_Nomi:
            ...
            #File_with_mtwMassFit_weight_Iso[channel] = "/nfs/home/common/RUN2_UL/Minitree_corr_bweight_with_mtwMassFit_Scale_new/"+yearDir[year]+"/2J1T1/"+year+'_'+channel+'_Apply_all_'+lep+'.root'
            if(channel=="QCD"): Data_AntiIso_Fpath =  "/nfs/home/common/RUN2_UL/Minitree_corr_bweight_with_mtwMassFit_Scale/"+yearDir[year]+"/2J1T1/"+year+'_'+channel+'_Apply_all_'+lep+'.root'
    ...
    Data_AntiIso_Fpath =  "/nfs/home/common/RUN2_UL/Minitree_with_mtw_weight/2J1T1/"+year+'_QCD_Apply_all_'+lep+'.root'
    Data_Iso_Fpath =  "/nfs/home/common/RUN2_UL/Minitree_with_mtw_weight/2J1T1/"+year+'_'+channel+'_Apply_all_'+lep+'.root'
    ...
    if(isr_fsr_sys or allsys):
        ...
        for channel in channels_top_only:
            Fpaths_orignal_minitree[channel] = f"/nfs/home/common/RUN2_UL/Minitree_corr_bweight/{yearDir[year]}/2J1T1/Minitree_{channel}_2J1T1_{lep}.root"
